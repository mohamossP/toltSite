...
const ACCENT = "#2A6496";
const ACCENT_LIGHT = "#D6E8F5";
const BG = "#F0F6FB";
const INK = "#111820";
const MUTED = "#5A7A90";

// ── Tölt-AI Logo Component ──────────────────────────────────────────────────
...
const features = [
  {
    ...
    desc: "Deploy intelligent agents that plan, reason, and act across your business processes — autonomously completing multi-step workflows that once required entire teams.",
  },
  {
    num: "02",
    title: "Business Process Automation",
    desc: "Map your existing workflows and let Tölt-AI agents handle the repetitive, rule-bound, and data-intensive tasks — freeing your people for high-value work.",
  },
  {
    num: "03",
    title: "Local LLM Solutions",
    desc: "Run powerful language models entirely within your infrastructure. No data leaves your environment — ideal for healthcare, government, and regulated industries.",
  },
  {
    num: "04",
    title: "Training & Enablement",
    desc: "We don't just deploy — we upskill. Tailored training programmes ensure your teams understand, trust, and confidently extend the AI solutions we build together.",
  },
];
...
const TeamIllustrations = {
  "AI Strategy": (
    <svg width="100%" height="100%" viewBox="0 0 300 220" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Grid lines */}
      {[0,1,2,3,4].map(i => (
        <line key={`h${i}`} x1="0" y1={44*i+22} x2="300" y2={44*i+22} stroke="#2A6496" strokeWidth="0.5" strokeOpacity="0.4"/>
      ))}
      {[0,1,2,3,4,5].map(i => (
        <line key={`v${i}`} x1={50*i+0} y1="0" x2={50*i+0} y2="220" stroke="#2A6496" strokeWidth="0.5" strokeOpacity="0.4"/>
      ))}
      {/* Bar chart */}
      ...
      {/* Nodes on trend */}
      {[[54,135],[99,95],[144,65],[189,45],[234,75]].map(([cx,cy],i) => (
        <circle key={i} cx={cx} cy={cy} r="4" fill="#fff" opacity="0.9"/>
      ))}
      {/* Label */}
  ...
  "Engineering": (
    <svg width="100%" height="100%" viewBox="0 0 300 220" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Nodes */}
      {[[50,60],[150,60],[150,110],[250,110],[80,150],[220,150],[220,90],[260,90]].map(([cx,cy],i) => (
        <circle key={i} cx={cx} cy={cy} r="4" fill="#CC2200" opacity="0.9"/>
      ))}
      {/* Glowing dot */}
...
const testimonials = [
  {
    quote:
      "Tölt-AI automated our patient intake and triage workflows. Our clinical staff reclaimed hours every shift — without compromising on compliance.",
    name: "Dr. A. Hassan",
    company: "Director of Digital Health, Regional Hospital Network",
  },
  {
    quote:
      "The local LLM deployment was a game-changer for us. Sensitive citizen data stays on-premises, and the agents still perform beautifully.",
    name: "M. Okonkwo",
    company: "Head of IT, Municipal Government Authority",
  },
  {
    quote:
      "We piloted Tölt-AI across three departments. The training programme made adoption smooth — staff went from sceptical to advocates in two weeks.",
    name: "Prof. L. Strand",
    company: "VP Operations, National University",
  },
];
  ...
  return (
    <div style={{ background: BG, color: INK, fontFamily: "'Lato', sans-serif", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        background: scrolled ? "rgba(230,243,251,0.95)" : "transparent",
        backdropFilter: scrolled ? "blur(12px)" : "none",
        borderBottom: scrolled ? "1px solid #B8D4E8" : "1px solid transparent",
      ...
      <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", padding: "120px clamp(24px, 8vw, 140px) 80px", position: "relative" }}>
        ...
        <div style={{ position: "relative", maxWidth: 760 }}>
          ...
          <div style={{ opacity: 1, animation: "none" }}>
            <p style={{ fontSize: 11, letterSpacing: "0.18em", color: ACCENT, fontWeight: 500, textTransform: "uppercase", marginBottom: 28 }}>
          ...
          >
            ...
            <em style={{ fontStyle: "italic", color: ACCENT }}>Amplify</em> the people.
          </h1>
          ...
          <p style={{ marginTop: 24, fontSize: 12, color: MUTED, letterSpacing: "0.04em", animation: "fadeUp 0.9s 0.45s ease both" }}>
            On-premise · Compliant · Sector-specialist
          </p>
        </div>
      ...
      <section id="features" style={{ padding: "120px clamp(24px, 8vw, 140px)" }}>
        <Reveal>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 64, flexWrap: "wrap", gap: 24 }}>
            <h2 style={{ fontFamily: "'EB Garamond', serif", fontSize: "clamp(36px, 5vw, 58px)", fontWeight: 400, lineHeight: 1.1 }}>
              Four pillars.<br />One reliable platform.
            </h2>
            <p style={{ fontSize: 14, color: MUTED, maxWidth: 280, lineHeight: 1.8, fontWeight: 400 }}>
              From strategy to deployment to training — Tölt-AI covers the full lifecycle of intelligent automation.
            </p>
          </div>
        </Reveal>
      ...
      <section id="team" style={{ padding: "120px clamp(24px, 8vw, 140px)", background: "#DCF0F9" }}>
        <Reveal>
          ...
          <h2 style={{ fontFamily: "'EB Garamond', serif", fontSize: "clamp(36px, 5vw, 58px)", fontWeight: 400, marginBottom: 64 }}>
            Deep expertise.<br />Sector by sector.
          </h2>
        </Reveal>
              ...
              <div className="team-card">
                <div className="team-img" style={{
                  ...
                  <div style={{
                    ...
                    background: "linear-gradient(160deg, rgba(42,100,150,0.15) 0%, rgba(17,24,32,0.3) 100%)",
                  }} />
                </div>
          ...
          {testimonials.map((t, i) => (
            <Reveal key={i} delay={i * 100}>
              <div className="testimonial-card">
                <p style={{ fontFamily: "'EB Garamond', serif", fontSize: 20, fontWeight: 400, lineHeight: 1.65, marginBottom: 28, fontStyle: "italic" }}>
                  "{t.quote}"
                </p>
      ...
      <section id="contact" style={{ padding: "120px clamp(24px, 8vw, 140px)", background: INK, color: "#FAF9F6" }}>
        <Reveal>
          <div style={{ maxWidth: 560 }}>
            ...
            <h2 style={{ fontFamily: "'EB Garamond', serif", fontSize: "clamp(36px, 5vw, 64px)", fontWeight: 400, lineHeight: 1.1, marginBottom: 24 }}>
              Ready to automate<br />with confidence?
            </h2>
            <p style={{ fontSize: 15, color: "#8A8880", fontWeight: 400, lineHeight: 1.8, marginBottom: 48 }}>
              Tell us about your organisation and we'll tailor a solution for your sector — on-premise, compliant, and built to last.
            </p>
            {sent ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14, maxWidth: 480 }}>
                <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
                  <input
                    ...
                    style={{ flex: 1, minWidth: 180, background: "#162535", border: "1px solid #2A4A65", color: "#FAF9F6" }}
                    type="text"
                ...
                <textarea
                  className="input-field"
                  style={{ background: "#162535", border: "1px solid #2A4A65", color: "#FAF9F6", resize: "vertical", minHeight: 110, lineHeight: 1.7 }}
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 20, flexWrap: "wrap" }}>
                  <button className="cta-btn" style={{ background: ACCENT, whiteSpace: "nowrap" }} onClick={handleSubmit}>
                    Get in Touch →
                  </button>
                </div>
              </div>
